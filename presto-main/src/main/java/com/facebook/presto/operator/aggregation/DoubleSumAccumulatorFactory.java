...
public class DoubleSumAccumulatorFactory
        implements AccumulatorFactory
{
    private final int inputChannel;

    public DoubleSumAccumulatorFactory(int inputChannel)
    {
    ...
    {
        return new DoubleSumAccumulator(inputChannel);
    }
    ...
    {
        return new DoubleSumGroupedAccumulator(inputChannel);
    }
