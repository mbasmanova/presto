...
public class RealSumAccumulatorFactory
        implements AccumulatorFactory
{
    private final int inputChannel;

    public RealSumAccumulatorFactory(int inputChannel)
    {
    ...
    {
        return new RealSumAccumulator(inputChannel);
    }
    ...
    {
        return new RealSumGroupedAccumulator(inputChannel);
    }
