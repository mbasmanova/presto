        ...
        extends InputStream
{
    ...
    private byte[] tempDouble = new byte[SIZE_OF_DOUBLE];
            ...
            throws IOException
    {
        ...
        if (readPosition < 0) {
            return ByteArrays.getDouble(tempDouble, 0);
        }
